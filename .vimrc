...
Plugin 'mbbill/undotree'                        "Neat visuals on undoing stuff, mapped to /u
...
""""""""""""""""""""""""""""
"Backups for vim overwrites"
""""""""""""""""""""""""""""
set backup                              "Keep backup file after overwriting
set backupdir=~/.vim-bak/backup
set swapfile                            "Allow creaion of .swp swap files
set writebackup                         "Make a backup file before overwriting a file
if exists('+undofile')                  "Have Vimsave undo history to file and restore on open
    set undofile
endif
